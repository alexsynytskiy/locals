    ...
    <div id="content" class="site-content">
        <div id="primary" class="content-area">
            <main id="main" class="site-main">
                ...
                <div class="red-title-bordered clearfix">
                    <div class="red-title-bordered-wrapper">
                        рисунки та етюди
                    </div>
                    ...
                    <div class="footer-wrapper">
                        ...
                        <div class="info-contacts">
                            <a target="_blank" href="https://goo.gl/maps/rntiO" class="adress">
                                <div class="text">вул. Дніпровська, 1</div>
                                <div class="text">м. Канів, 19000, Україна</div>
                            </a>

                            <a tabindex="-1" href="tel:+380952833833" class="adress">
                                <div class="text">тел.: +380 95 283 38 33</div>
                            </a>

                            <a href="http://www.knyazhahora.com/" target="_blank" class="main-site"
                               style="font-family: 'gothapro_regular';">
                                <div class="main-site-link" style="margin-top: 0;">
                                    knyazhahora.com
                                </div>
                            </a>

                            <a href="http://www.intsign.co/" target="_blank" class="main-site clearfix">
                                <div class="main-site-link">
                                    developed at INTSIGN
                                </div>
                            </a>
